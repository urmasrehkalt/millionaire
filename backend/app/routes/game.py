...
from backend.app.services.game_logic import SessionNotFoundError, create_session, submit_answer
from backend.app.services.question_generator import generate_questions
...
def start_game(req: StartGameRequest) -> StartGameResponse:
    ...
    questions = generate_questions(assignment)
    return create_session(req.assignment_id, questions)
